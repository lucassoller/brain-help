...
public class TelaContatoCardActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.perfil:
                Intent itTelaUsuario = new Intent(TelaContatoCardActivity.this, TelaPerfilActivity.class);
                itTelaUsuario.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(itTelaUsuario);
                return true;
            case R.id.alterar_senha:
                Intent itTelaSenha = new Intent(TelaContatoCardActivity.this, TelaContatoCardActivity.class);
                itTelaSenha.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(itTelaSenha);
                return true;
            case R.id.desempenhos:
                Intent itTelaDesempenho = new Intent(TelaContatoCardActivity.this, TelaDesempenhosActivity.class);
            ...
            case R.id.sair:
                ...
                Intent itTelaInicial = new Intent(TelaContatoCardActivity.this, TelaInicialActivity.class);
